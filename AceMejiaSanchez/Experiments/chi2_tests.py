...
print(" ")
print("                RUNNING MEASURE PATTERNS NOW FOR SMALL DATASET        ")
print(" ")
# Split dataset into X_train and y_train
X_train, X_test, y_train, y_test = train_test_split(df_categorical.iloc[:,1:15], df_table.iloc[:,-1], test_size=0.2, random_state=52)

# Call the measure_patterns function
Measure_Patterns(X_train, y_train)

print(" ")
print("                RUNNING MEASURE PATTERNS NOW FOR LARGE DATASET        ")
print(" ")
# Split dataset into X_train and y_train
X_train, X_test, y_train, y_test = train_test_split(df.iloc[:,1:150], df_table.iloc[:,-1], test_size=0.2, random_state=52)
